...
// Chinese carries two codes that differ by SCRIPT, not region: `zh` is
// Simplified (the source content), `zh-Hant` is Traditional (derived from it by
// scripts/gen_zh_hant.mjs). normalize() routes tags to one or the other.
var I18N_SUPPORTED = ["en", "es", "zh", "zh-Hant", "vi", "tl", "ko"];
// Each language's name in its own script, for the selector.
var I18N_AUTONYMS = { en: "English", es: "Español", zh: "中文（简体）", "zh-Hant": "中文（繁體）", vi: "Tiếng Việt", tl: "Tagalog", ko: "한국어" };
// Human language name to ask an external AI to reply in (used in hand-off prompt).
var I18N_REPLY_LANG = { en: "English", es: "Spanish", zh: "Simplified Chinese", "zh-Hant": "Traditional Chinese", vi: "Vietnamese", tl: "Tagalog", ko: "Korean" };
...
// audience, not the language's country of origin — EXCEPT Chinese, where the
// meaningful axis is script, so we emit zh-CN (Simplified) / zh-TW (Traditional)
// to carry that signal (zh-US would be ambiguous — US Chinese readers split
// between the two scripts). The region is otherwise just a label: normalize()
// discards it on read (every tag maps back to a base language; only the Chinese
// script is preserved) and also tolerates a bare code or any other region.
var I18N_LOCALES = { en: "en-US", es: "es-US", zh: "zh-CN", "zh-Hant": "zh-TW", vi: "vi-US", tl: "tl-US", ko: "ko-US" };
...
TRANSLATIONS["zh-Hant"] = {
  "meta.title": "2026 年加州州長初選 — 候選人匹配工具",
  "meta.description": "找出在加州 2026 年 6 月 2 日州長初選中，哪位候選人最契合你的價值觀。以差異為先的提問、註明出處的來源、公開數據集。",
  "header.langAria": "選擇語言",
  "header.h1": "加州 2026 年州長 — 候選人匹配工具",
  "header.subtitle": "面向 2026 年 6 月 2 日的州長初選。先選出你的立場，再與各候選人的真實立場進行匹配。",
  "status.loading": "正在加載數據集…",
  "status.noQuestions": "尚未配置問題。請運行 scripts/score_questions.mjs 後重新部署。",
  "status.loadFailed": "加載失敗：{msg}",
  "intro.about.h2": "這是什麼？",
  "intro.about.lead": "一種非黨派的方式，幫你找出在加州 2026 年 6 月州長初選中你真正契合的候選人——以及確切的原因。有幾點讓它有別於一般的候選人測驗：",
  "intro.about.differ": "<strong>只問候選人立場真正不同的問題。</strong>沒有“你支持好學校嗎？”這類填充題——每道題都是各候選人確實存在分歧的議題，按分歧程度挑選。",
  "intro.about.keepAsking": "<strong>你可以繼續追問。</strong>從任何一道題，把該話題交給 ChatGPT 或 Claude——它們會預先加載該話題註明出處的指南——你想深入到什麼程度都可以。它也能在像 <a href=\"https://www.diabrowser.com/\" target=\"_blank\" rel=\"noopener\">Dia</a> 這樣的智能瀏覽器中使用，或者把提示詞複製到你喜歡的任何 AI 助手裡。",
  "intro.about.dataset": "<strong>一個由 AI 研究、完整註明出處的數據集。</strong>每位候選人的立場都由 AI 從原始來源研究並整理而成——而非由研究團隊人工篩選——並且每條都鏈接到一段標註日期的引文，你可以自行打開核對。",
  "intro.how.h2": "運作方式",
  "intro.how.count": "總共 {count} 道題——任何你不想回答的都可以跳過。",
  "intro.how.importance": "每題都有重要程度滑塊；默認為中等，讓你可以直接作答。",
  ...
  "intro.share": "分享此測驗",
  "intro.snapshot": "快照日期：",
  "intro.shareCopied": "測驗鏈接已複製到剪貼板 ✓",
  "faq.h3": "常見問題 &amp; 方法說明",
  "faq.q1.s": "這些問題是如何挑選的？",
  "faq.q1.a": "每道題都是候選人立場<em>確實</em>不同的議題。我們從候選人立場的完整矩陣出發，按<strong>差異分數</strong>對每個議題排序——即各候選人立場分佈的離散程度，再依據該議題被研究的充分程度進行加權。你看到的問題就是分歧最大的議題。幾乎所有人都一致認同的話題則成為腳註，而非問題。（包括分歧較小議題在內的完整排序，都收錄在公開數據集中。）",
  "faq.q2.s": "候選人立場是如何研究出來的？",
  "faq.q2.a": "該數據集由 AI 從原始來源研究並整理而成——沒有人工研究團隊進行篩選。讓它保持誠實的保障是：每項立場都鏈接到一個原始來源——競選官網、採訪、辯論實錄、評論文章或投票記錄——附有逐字引文、鏈接和日期；任何候選人未公開表態的議題都標記為<em>“未知”</em>，而非憑空猜測（200 項立場中有 10 項是誠實的未知）。所以你永遠不必只聽信 AI 的說法——打開任何立場的來源，自己核對即可。在任何問題上展開“背景 &amp; 論點”即可查看出處。",
  "faq.q3.s": "如果我認為某項立場有誤怎麼辦？",
  "faq.q3.a": "在你的結果頁面，展開任一候選人下方的<strong>“看看你為何匹配”</strong>——每條註明出處的立場都帶有<strong>⚑ 標記此項</strong>按鈕。你也可以在 <a href=\"https://github.com/ternarybits/california-election\" target=\"_blank\" rel=\"noopener\">GitHub</a> 上提交 issue 或 pull request。兩種途徑都匯入同一個更正隊列，而且整個數據集都是公開的，任何人都可以審核。",
  "faq.q4.s": "我的匹配度是如何計算的？",
  "faq.q4.a": "簡單、可審核的算法——沒有黑箱式的 AI 排名。對每道題，我們在同一量表上比較你的立場與各候選人的立場，再按你認為該議題的重要程度加權，然後求平均。你會得到<strong>兩項獨立評分</strong>——政策匹配度和個人契合度——它們絕不會合併成單一數字。在某題上立場為“未知”的候選人，該題就不參與其評分。",
  "faq.q5.s": "這個工具有黨派立場嗎？",
  "faq.q5.a": "沒有——這是一個非黨派的開源項目，不是背書引擎。每個立場量表的設計都讓兩端都不是“正確答案”，每道題都呈現了雙方經過嚴謹論證的論點。目標是幫你找到<em>契合</em>，而不是告訴你該投給誰。代碼和數據都託管在 <a href=\"https://github.com/ternarybits/california-election\" target=\"_blank\" rel=\"noopener\">GitHub</a> 上。",
  "faq.q6.s": "我能就某個話題深入瞭解嗎？",
  "faq.q6.a": "可以——這是我最為期待的部分。在每道題下方的“深入瞭解”處，輸入一個問題，一鍵把該話題交給 <strong>ChatGPT</strong> 或 <strong>Claude</strong>——它會預先加載該話題註明出處的指南，讓 AI 能基於相同的原始來源進行推理。它也能在像 <a href=\"https://www.diabrowser.com/\" target=\"_blank\" rel=\"noopener\">Dia</a> 這樣能直接讀取頁面的智能瀏覽器中使用，還有一個<strong>複製提示詞</strong>按鈕，方便你粘貼到任何你偏好的 AI 助手中。進階用戶還可以把本項目的 <strong>MCP server</strong> 連接到 Claude 或 Cursor——詳見 GitHub 倉庫。",
  "faq.q7.s": "我的數據會被追蹤嗎？",
  "faq.q7.a": "我們會記錄匿名的彙總計數（哪些答案被選中、匹配到哪位候選人），用於生成公開的統計頁面。不使用 cookie，不記錄 IP 地址，不建立個人檔案。你的個人答案保留在你的瀏覽器中，你可分享的結果鏈接把答案編碼在 URL 裡——而非存儲在我們的服務器上。",
  "faq.q8.s": "這些信息有多新？我能在自己的 AI 助手裡使用它嗎？",
  "faq.q8.a": "每個頁面都標註快照日期；立場在競選期間可能發生變化，因此我們對數據集進行版本管理，並隨著 2026 年 6 月初選臨近重新核查。我們還提供一個 <strong>MCP server</strong>，把數據集接入 Claude 或 Cursor，讓你可以就這些議題進行對話式探討——設置方法詳見 GitHub 倉庫。",
  "faq.q9.s": "這是誰做的——又為什麼要做？",
  "faq.q9.a": "由 <a href=\"https://www.linkedin.com/in/tedmao/\" target=\"_blank\" rel=\"noopener\">Ted Mao</a> 打造。第一個版本是在我所屬的風投機構 <a href=\"https://thegp.com\" target=\"_blank\" rel=\"noopener\">The General Partnership</a> 的一次 AI hack-day 上做出來的，之後我把它整理好分享出來。它也是一個小小的展示，說明 AI 能在多大程度上端到端地推進一個項目——研究數據集、搭建應用，以及驅動產品內的追問功能。我是 <a href=\"https://www.gumnut.ai\" target=\"_blank\" rel=\"noopener\">Gumnut</a> 的創始人；這是個人的業餘項目，不隸屬於任何競選團隊。",
  "pq.phase": "政策問題",
  "pq.guideHeading": "背景 &amp; 論點",
  "pq.askHeading": "深入瞭解",
  "pq.importance": "這道題對你有多重要？",
  "imp.low": "低",
  "imp.medium": "中",
  "imp.high": "高",
  "nav.back": "← 返回",
  "nav.skip": "跳過",
  "nav.next": "下一題 →",
  "pq.progress": "第 {n} 題，共 {total} 題",
  "fq.phase": "個人契合度",
  "fq.skip": "無偏好",
  "fq.progress": "個人契合度第 {n} 項，共 {total} 項",
  "vg.basics": "基本情況",
  "vg.current": "加州當前政策",
  "vg.argsFor": "支持改變的論點",
  "vg.argsAgainst": "反對改變的論點",
  "vg.keyFacts": "關鍵事實",
  "vg.comparison": "加州相比之下如何",
  "vg.noteOnOptions": "關於選項的說明",
  "vg.sources": "來源",
  "vg.moreSummary": "更多背景——關鍵事實、加州的對比情況、來源",
  "askai.label": "對這個話題有疑問？問問 AI 助手。",
  "askai.placeholder": "例如：這會如何影響我所在城市的租客？",
  "askai.chatgpt": "問 ChatGPT →",
  "askai.claude": "問 Claude →",
  "askai.copy": "複製提示詞",
  "askai.copied": "已複製 ✓",
  "askai.hint": "會在新標籤頁打開你自己的 AI，並附上該話題註明出處的指南。請勿包含個人信息。",
  "prompt.withQ": "我正在研究 2026 年加州州長競選。我關於“{name}”的問題：{question}",
  "prompt.withoutQ": "我正在研究 2026 年加州州長競選。請幫我理解“{name}”——雙方的主要論點，以及主要候選人在哪些方面存在分歧。",
  "prompt.body": "這是一份中立的入門指南，列出了每位候選人的立場及原始來源：{url}\n\n請以此為起點，但也歡迎你更廣泛地研究。請註明你的來源，並告訴我哪些內容尚不確定或自那以來可能已有變化。",
  "prompt.replyIn": "請用中文回答。",
  "results.heading": "你的匹配：{name}",
  "results.headingNone": "你的匹配",
  "results.stale": "提示：這個分享鏈接是基於數據集 {staleVersion} 生成的，而當前數據集為 {currentVersion}。部分立場自那以來可能已有變化，因此此匹配結果可能有偏差——請重新測驗以獲得最新結果。",
  "results.copyLink": "複製分享鏈接",
  "results.retake": "重新測驗",
  "results.seeStats": "看看大家是怎麼回答的",
  "results.cardCopied": "分享卡片鏈接已複製到剪貼板 ✓",
  "results.rankingHeading": "你與每位候選人的匹配情況",
  "results.method": "依據 <code>{label}</code> 評分。每位候選人有兩項評分：<strong>政策匹配度</strong>（在你看重的議題上你們的一致程度）和<strong>個人契合度</strong>（背景、履歷、聯盟等）。特意分開展示——絕不混合。",
  "score.policy": "政策",
  "score.personalFit": "個人契合度",
  "rank.scored": "已評分 {p} 道政策題 · 已評分 {f} 項個人契合維度",
  "rank.seeWhy": "看看你為何匹配——並標記任何有誤之處",
  "receipt.agreedOn": "你們一致的議題",
  "receipt.disagreedOn": "你們分歧的議題",
  "receipt.noAgree": "沒有已評分的一致項。",
  "receipt.noDisagree": "沒有已評分的分歧項。",
  "receipt.agreePct": "{pct}% 一致",
  "receipt.apartPct": "{pct}% 分歧",
  "receipt.youVs": "你：{you} · {name}：{them}",
  "receipt.stanceFallback": "立場 {value}",
  "receipt.source": "來源",
  "receipt.flag": "⚑ 標記此項",
  "receipt.flagPrompt": "標記 {name} 在“{issue}”上的立場——哪裡有誤？",
  "receipt.sending": "正在發送…",
  "receipt.flagged": "已標記 ✓",
  "receipt.failed": "失敗",
  "whynot.h3": "為什麼不是你的第二名？",
  "whynot.body": "你的最高匹配是 <strong>{top}</strong>，匹配度 {topPct}%。<strong>{runner}</strong>（{runnerPct}%）在 {lines} 上略勝一籌。",
  "whynot.and": "和",
  "whatif.summary": "如果我換個答案會怎樣？",
  "whatif.pick": "選擇一道政策題：",
  "whatif.optionLabel": "{issue} — 你選的是：{label}",
  "whatif.alt": "→ 如果你選的是：{label}",
  "whatif.newTop3": "新的前三名（相比你原有排名的變化）：",
  "whatif.row": "{name} — {pct}% 政策匹配（原為 {was}%）",
...
(function () {
  ...
  // Map a BCP-47 tag to one of our supported codes. Accepts hyphen (en-US) and
  // underscore (en_US) region separators, and a bare language code (en). For
  // most languages only the primary subtag matters; Chinese splits by SCRIPT —
  // Traditional (zh-Hant, or the zh-TW/HK/MO regions) → zh-Hant, everything else
  // Chinese (zh-Hans/zh-CN/zh-SG/bare zh) → zh (Simplified). fil → tl.
  function normalize(tag) {
    if (!tag) return null;
    var lower = String(tag).toLowerCase();
    var subtags = lower.split(/[-_]/);
    var primary = subtags[0];
    if (primary === "zh") {
      var rest = subtags.slice(1);
      var traditional = rest.indexOf("hant") !== -1 || rest.indexOf("tw") !== -1 ||
        rest.indexOf("hk") !== -1 || rest.indexOf("mo") !== -1;
